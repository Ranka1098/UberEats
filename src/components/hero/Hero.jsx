...
const Hero = () => {
  return (
      <div className='max-w-[1640px] mx-auto p-4'>
        ...
        {/* image coming from pexel.com website*/}
        <img 
        className='w-full max-h-[500px] object-cover'
        src="https://images.pexels.com/photos/1639562/pexels-photo-1639562.jpeg?auto=compress&cs=tinysrgb&w=600" alt="food image..." />
      </div>
      </div>
  )
}
